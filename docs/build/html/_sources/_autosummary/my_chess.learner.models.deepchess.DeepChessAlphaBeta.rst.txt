...
.. autoclass:: DeepChessAlphaBeta
   ...
   .. autosummary::
      ...
      ~DeepChessAlphaBeta.float
      ~DeepChessAlphaBeta.forward
      ...
      ~DeepChessAlphaBeta.ipu
      ~DeepChessAlphaBeta.iterate_depths
      ~DeepChessAlphaBeta.load_state_dict
      ~DeepChessAlphaBeta.max_player
      ~DeepChessAlphaBeta.max_value
      ~DeepChessAlphaBeta.min_player
      ~DeepChessAlphaBeta.min_value
      ~DeepChessAlphaBeta.modules
      ~DeepChessAlphaBeta.named_buffers
      ~DeepChessAlphaBeta.named_children
      ~DeepChessAlphaBeta.named_modules
      ~DeepChessAlphaBeta.named_parameters
      ~DeepChessAlphaBeta.parameters
      ~DeepChessAlphaBeta.parse_compare
      ~DeepChessAlphaBeta.register_backward_hook
      ~DeepChessAlphaBeta.register_buffer
      ~DeepChessAlphaBeta.register_forward_hook
      ~DeepChessAlphaBeta.register_forward_pre_hook
      ~DeepChessAlphaBeta.register_full_backward_hook
      ~DeepChessAlphaBeta.register_load_state_dict_post_hook
